...
#Created 2020-08-12 at 15:32

rplots.level <- 1
xpose.runno <- '01'
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
pdf.title <- 'execute diagnostic plots run 01'
working.directory<-'/Users/jernest/Dropbox/PSPG_paperwork/Bootcamp_2020/bootcamp_2020/nm/modelfit_dir2/'
model.directory<-'/Users/jernest/Dropbox/PSPG_paperwork/Bootcamp_2020/bootcamp_2020/nm/'
results.directory <- '/Users/jernest/Dropbox/PSPG_paperwork/Bootcamp_2020/bootcamp_2020/nm/'
model.filename<-'run01.mod'
subset.variable<-NULL
mod.suffix <- '.mod'
mod.prefix <- 'run'
tab.suffix <- ''
rscripts.directory <- '/usr/local/Cellar/perl/5.30.0/lib/perl5/site_perl/5.30.0/PsN_4_8_1/R-scripts'
raw.results.file <- 'raw_results_run01.csv'
theta.labels <- c('1 Additive Error','2 Proportional Error','3 CL L/h','4 V L','5 KA 1/h','6 Q','7 V2','8 effect of HIV','9 effect of BW')
theta.fixed <- c(TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE)
omega.labels <- c('1 Additive Error_','2 IIV CL')
omega.fixed <- c(TRUE,TRUE)
